...
export type UserRole = "admin" | "gerente" | "garcom" | "motoboy";

export type ItemStatus = "pendente" | "em_preparo" | "pronto" | "cancelado";
...
export type TableStatus = "disponivel" | "ocupada" | "bloqueada";

export type PresentationTableStatus =
  | "livre"
  | "ocupada"
...
// ResponseDto com info de sessão incluída
...
export interface TableWithSessionInfo extends TablePublic {
  session_id: string | null;
  session_status: "aberta" | "fechamento_solicitado" | null;
  session_guest_count: number | null;
...
export type PaymentStatus = "pendente" | "confirmado" | "recusado" | "expirado";
